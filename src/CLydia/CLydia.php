...
class CLydia implements ISingleton {
	...
	protected function __construct() {
		...
		$ly = &$this;
    require(MOZART_SITE_PATH.'/config.php');
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= MOZART_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = MOZART_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    include(MOZART_INSTALL_PATH . '/themes/functions.php');
